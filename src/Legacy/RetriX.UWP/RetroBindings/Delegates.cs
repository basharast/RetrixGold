...
namespace LibRetriX.RetroBindings
{
    ...
    /// </summary>
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    public delegate long VFSTruncateDelegate(IntPtr stream, long length);

    /// <summary>
    /// Introduced in VFS API v3.
    /// </summary>
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    public delegate int VFSStatDelegate(IntPtr path, IntPtr size);

    /// <summary>
    /// Introduced in VFS API v3.
    /// </summary>
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    public delegate int VFSMkdirDelegate(IntPtr dir);

    /// <summary>
    /// Introduced in VFS API v3.
    /// </summary>
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    public delegate IntPtr VFSOpendirDelegate(IntPtr name, bool include_hidden);

    /// <summary>
    /// Introduced in VFS API v3.
    /// </summary>
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    public delegate bool VFSReaddirDelegate(IntPtr rdir);

    /// <summary>
    /// Introduced in VFS API v3.
    /// </summary>
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    public delegate IntPtr VFSDirentGetNameDelegate(IntPtr rdir);

    /// <summary>
    /// Introduced in VFS API v3.
    /// </summary>
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    public delegate bool VFSDirentIsDirDelegate(IntPtr rdir);

    /// <summary>
    /// Introduced in VFS API v3.
    /// </summary>
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    public delegate int VFSClosedirDelegate(IntPtr rdir);
    #endregion
}
