...
namespace SharpCompress.Compressors.BZip2
{
    ...
    internal sealed class CBZip2OutputStream : Stream
    {
        ...
        */
                                                ...
                                                int alphaSize, int maxLen)
        {
            ...
            */
            ...
            Span<int> heap = new int[BZip2Constants.MAX_ALPHA_SIZE + 2]; // 1040 bytes
            Span<int> weight = new int[BZip2Constants.MAX_ALPHA_SIZE * 2];  // 1040 bytes
            Span<int> parent = new int[BZip2Constants.MAX_ALPHA_SIZE * 2];  // 1040 bytes
        ...
        */
        ...
        {
            int i, j, ss, sb;
            Span<int> runningOrder = new int[256];
            Span<int> copy = new int[256];
