...
namespace SharpCompress.Archives
{
    ...
    {
        public static void WriteTo(this IArchiveEntry archiveEntry, Stream streamToWriteTo, IProgress<double> progress)
        {
            ...
            using (entryStream)
            {
                ...
                {
                    s.TransferTo(streamToWriteTo, progress);
                }
            }
