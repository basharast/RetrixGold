...
namespace SharpCompress.Archives.Zip
{
    public class ZipArchive : AbstractWritableArchive<ZipArchiveEntry, ZipVolume>
    {
        ...
        public void SaveTo(Stream stream, IProgress<Dictionary<string, long>> progress = null)
        {
            SaveTo(stream, new WriterOptions(CompressionType.Deflate), progress);
        }

        protected override void SaveTo(Stream stream, WriterOptions options,
                                       IEnumerable<ZipArchiveEntry> oldEntries,
                                       IEnumerable<ZipArchiveEntry> newEntries, IProgress<Dictionary<string, long>> progress = null)
        {
